                ...
                <form action="{{route('admin.footer-info.update',1)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea name="info" id="" class="form-control" style="height: 100px"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="copy_right" class="form-control" value="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <input type="text" name="powered_by" class="form-control" value="">
                        </div>
                    </div>
